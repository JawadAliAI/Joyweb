...
const ZH_DICTIONARY: Record<string, string> = {
  ...
  'Accounts and their balances': '用户账户列表及余额资产管理',
  'Withdrawal requests': '提币申请审核与出金处理',
  'Withdrawal requests — no blockchain transfer is involved': '提币申请审核与出金处理',
  'Withdrawal requests – no blockchain transfer is involved': '提币申请审核与出金处理',
  'Platform activity at a glance': '全站运营数据与关键指标概览',
  'Tradable pairs offered on the trade screen': '行情币对及交易参数设置',
  ...
  'Runtime configuration for the platform': '系统基础参数与偏好配置',
  'Internal account score changes': '用户信用分调整与评级记录',
  ...
  'Active users': '活跃用户',
  'Frozen users': '已冻结用户',
  'Total balances': '全站总资产',
  'Trades today': '今日订单数',
  'Trade volume': '今日交易量',
  'Pending withdrawals': '待审核出金',
  'Open tickets': '待处理工单',
  'User registrations': '用户注册趋势',
  'New accounts per day': '每日新增注册用户数',
  'Trading volume': '交易量走势',
  'Stake placed per day': '每日订单交易金额走势',
  'Deposits': '入金充值趋势',
  'Deposits per day': '每日入金到账金额走势',
  'Withdrawals per day': '每日出金提币金额走势',
  'Withdrawals per day — no blockchain transfer is involved': '每日出金提币金额走势',
  'Balances by asset': '各币种资产分布',
  'Units held across every customer wallet': '平台用户各币种钱包资产汇总',
  'No balances yet.': '暂无资产数据。',
